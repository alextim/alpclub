...
### Замечания по оформлению
### Картинки
Размер картинки очень влияет на производительность сайта
- Формат JPG.
- Разрешение 72-96 dpi. 
- 24 Bit
- Редактировать в Adobe Photoshop или Corel PhotoPaint.
- Сохранять с оптимизацией для Web.
- Имена файлов, отражающее предназначение файла и содержание картинки.
