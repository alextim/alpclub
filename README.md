...
- Для оформления текстов не применять in-line стили. Можно только HTML-тэги и классы.
  ...
  Пример c использования тэга HTML `<h4>` подзаголовка 4-го уровня:   `<h4>Мой подзаголовок 4-го уровня</h4>`.  
  
  Пример применения классов CSS для оформления параграфа: `<p class="my-special-class">Мой текст</p>`.
