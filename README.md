...
Что нужно вводить (шесть пунктов).
...
Два вида ссылок
Для картинок, документов и прочего внутри сайта создавайте ссылки относителня корня сайта `/`, не используйте полное имя `https://alp.od.ua/`. 
...
Ссылки на внешние сайты и ресурсы.
