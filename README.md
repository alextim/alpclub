...
2. Строка со специальным постом - "ACO: Special post". Предполагается использование для самой важной новости (поста) на сайте.
...
- Ячейка свежие мерорприятия - "ACO: Recent Trips". Шесть последних мероприятий вертикально - картинки в виде иконок, краткая информация о мероприятии.
